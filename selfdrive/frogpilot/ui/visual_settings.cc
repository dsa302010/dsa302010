...
FrogPilotVisualsPanel::FrogPilotVisualsPanel(SettingsWindow *parent) : FrogPilotListWidget(parent) {
  ...
  for (const auto &[param, title, desc, icon] : visualToggles) {
    ...
    if (param == "AlertVolumeControl") {
      ...
      std::vector<QString> themeOptions{tr("Stock"), tr("Frog"), tr("Tesla"), tr("Stalin"), tr("Icenana"), tr("Joker"), tr("Night"), tr("Love"), tr("Duck"), tr("Heat"), tr("Blackhole"), tr("Desert"), tr("Bigcat"), tr("Donut"), tr("Sunburst"), tr("Ctncandy")};
